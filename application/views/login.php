        ...
        <div class="col-md-6">
          <div class="card p-5 text-dark">
            <div class="card-body">
              ...
              <form  action="<?php echo base_url();?>beranda/LoginHandler" method="POST" enctype="multipart/form-data">
                <div class="form-group">
                  <label>Username</label>
                  <input type="text" class="form-control" placeholder="Username" name="iduser"> </div>
                <div class="form-group">
