  ...
  <div class="py-5">
    <div class="container-fluid">
      <div class="row">
        ...
        <div class="col-md-9">
          <h1 class="text-primary text-left display-4">Perbarui Pengguna</h1>
          <div class="row">
            <div class="col-md-12">
              <div class="card-body">
                <form action="<?php echo base_url(); ?>admin/pengguna/ubah/<?php echo $data_pengguna->id_user; ?>" method="post">
                  <div class="form-group">
                    <label>ID User</label>
                    <input type="text" class="form-control" placeholder="ID User" required="required" id="iduser" name="iduser" value="<?php echo $data_pengguna->id_user; ?>"> </div>
                  <div class="form-group">
                    <label>Password</label>
                    <input type="password" class="form-control" placeholder="Password" required="required" id="passworduser" name="passworduser" value="<?php echo $data_pengguna->password; ?>"> </div>
                  <div class="form-group">
                    <label>Nama lengkap</label>
                    <input type="text" class="form-control" placeholder="Nama lengkap" required="required" name="namalengkap" id="namalengkap" value="<?php echo $data_pengguna->nama_lengkap; ?>"> </div>
                  <div class="form-group">
                    <label>Email</label>
                    <input type="email" class="form-control" placeholder="Email" required="required" name="emailuser" id="emailuser" value="<?php echo $data_pengguna->email; ?>"> </div>
                  <div class="form-group">
                    <label>Alamat</label>
                    <input type="text" class="form-control" placeholder="Alamat" required="required" name="alamatuser" id="alamatuser" value="<?php echo $data_pengguna->alamat; ?>"> </div>
                  <div class="form-group">
                    <label>No Telepon</label>
                    <input type="text" class="form-control" placeholder="No Telepon" required="required" name="notelpuser" id="notelpuser" value="<?php echo $data_pengguna->no_telp; ?>"> </div>
