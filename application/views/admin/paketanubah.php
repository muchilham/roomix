  ...
  <div class="py-5">
    <div class="container-fluid">
      <div class="row">
        ...
        <div class="col-md-9">
          <h1 class="text-primary text-left display-4">Perbarui Paketan</h1>
          <div class="row">
            <div class="col-md-12">
              <div class="card-body">
                <form action="<?php echo base_url(); ?>admin/paketan/ubah/<?php echo $data_paketan->id_paketan; ?>" method="post">
                  <div class="form-group">
                    <label>Nama Paketan</label>
                    <input type="text" class="form-control" placeholder="Nama Paketan" required="required" name="namapaketan" id="namapaketan" value="<?php echo $data_paketan->nama_paketan; ?>"> </div>
                  <div class="form-group">
                    <label for="exampleInputEmail1">Harga Paketan</label>
                    <input type="text" class="form-control" id="hargapaketan" placeholder="Harga Paketan" name="hargapaketan" value="<?php echo $data_paketan->harga_paketan; ?>"> </div>
                  <div class="form-group">
                    ...
                    <select class="custom-control custom-select" id="satuanpaketan" name="satuanpaketan">
                      ...
                      <option value="1" <?php if($data_paketan->satuan_paketan == '1') { echo "selected"; } ?>>One</option>
                      <option value="2" <?php if($data_paketan->satuan_paketan == '2') { echo "selected"; } ?>>Two</option>
                      <option value="3" <?php if($data_paketan->satuan_paketan == '3') { echo "selected"; } ?>>Three</option>
                    </select>
                  </div>
                  <div class="form-group">
                    ...
                    <select class="custom-control custom-select" id="statuspaketan" name="statuspaketan">
                      <option selected="">Open this select menu</option>
                      <option value="1" <?php if($data_paketan->status_paketan == '1') { echo "selected"; } ?>>One</option>
                      <option value="2" <?php if($data_paketan->status_paketan == '2') { echo "selected"; } ?>>Two</option>
                      <option value="3" <?php if($data_paketan->status_paketan == '3') { echo "selected"; } ?>>Three</option>
                    </select>
                  </div>
                  <div class="form-group">
                    ...
                    <select class="custom-control custom-select" id="idruangan" name="idruangan">
                      ...
                      <?php $no=1; foreach($select_ruangan as $data_ruangan) { ?>
                        <option value="<?php echo $data_ruangan->id_ruangan; ?>" <?php if($data_paketan->id_ruang == $data_ruangan->id_ruangan) { echo "selected"; } ?>><?php echo $data_ruangan->nama_ruangan; ?></option>
                      <?php } ?>
                    </select>
                    <h1 class="m-3">Peralatan</h1>
                    <div class="form-group mx-3 peralatan">
                      <label for="exampleInputEmail1">Peralatan</label>
                      <?php foreach($select_paketandetail as $data_paketandetail) { ?>
                        <select class="custom-control custom-select" id="idruangan" name="idperalatan[]">
                          <option selected="">Open this select menu</option>
                          <?php foreach($select_peralatan as $data_peralatan) { ?>
                            <option value="<?php echo $data_peralatan->id_peralatan; ?>" <?php if($data_paketandetail->id_peralatan == $data_peralatan->id_peralatan) { echo "selected"; } ?>><?php echo $data_peralatan->nama_peralatan; ?> - <?php echo $data_peralatan->id_peralatan; ?></option>
                          <?php } ?>
                        </select>
                      <?php } ?>
