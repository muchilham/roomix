  ...
  <div class="py-5">
    <div class="container-fluid">
      <div class="row">
        ...
        <div class="col-md-9">
          <h1 class="text-primary text-left display-4">Ruangan</h1>
          <div class="row">
            <div class="col-md-12 my-4">
              <div class="row">
                <div class="col-md-12">
                  <a href="<?php echo base_url(); ?>admin/ruangan/tambah" class="btn btn-primary text-light">Tambah</a>
                </div>
              </div>
              <table class="table my-2">
                ...
                <?php $no=1; foreach($select_ruangan as $data_ruangan) { ?>
                  <tr>
                    ...
                    <td><?php echo $data_ruangan->deskripsi_ruangan; ?></td>
                    <td><?php echo $data_ruangan->harga_ruangan; ?></td>
                    <td><?php echo $data_ruangan->satuan_ruangan == 0 ? "Per Hari" : "Per Hari"; ?></td>
                    <td><?php echo $data_ruangan->kapasitas_ruangan; ?></td>
                    <td><?php echo $data_ruangan->status_ruangan == 0 ? "Tidak Aktif" : "Aktif"; ?></td>
                    <td>
                      <a href="<?php echo base_url(); ?>admin/ruangan/ubah/<?php echo $data_ruangan->id_ruangan; ?>" class="btn btn-outline-primary">Ubah</a>&nbsp; &nbsp;
                      <a class="btn btn-primary"  href="#modal-hapus" data-toggle="modal" data-target="#modal-hapus<?php echo $data_ruangan->id_ruangan; ?>">Hapus</a>
                    </td>
                  </tr>

                  <div class="modal" id="modal-hapus<?php echo $data_ruangan->id_ruangan; ?>">
                    <div class="modal-dialog" role="document">
                      <div class="modal-content">
                        ...
                        <div class="modal-footer">
                          <a href="<?php echo base_url(); ?>admin/ruangan/hapus/<?php echo $data_ruangan->id_ruangan; ?>"><button type="button" class="btn btn-primary">Ya</button></a>
