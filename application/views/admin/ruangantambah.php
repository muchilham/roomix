  ...
  <div class="py-5">
    <div class="container-fluid">
      <div class="row">
        ...
        <div class="col-md-9">
          <h1 class="text-primary text-left display-4">Tambah Ruangan</h1>
          <div class="row">
            <div class="col-md-12">
              <div class="card-body">
                <form action="<?php echo base_url(); ?>admin/ruangan/tambah" method="post" enctype="multipart/form-data">
                  <div class="form-group">
                    <label>Nama Ruangan</label>
                    <input type="text" class="form-control" placeholder="Nama Ruangan" required="required" name="namaruangan" id="namaruangan"> </div>
                  <div class="form-group">
                    <label for="exampleInputEmail1">Deskripsi Ruangan</label>
                    <textarea class="form-control" id="deskripsiruangan" rows="3" placeholder="Deskripsi Ruangan" name="deskripsiruangan"></textarea>
                  </div>
                  <div class="form-group">
                    <label for="exampleInputEmail1">Harga Ruangan</label>
                    <input type="text" class="form-control" id="hargaruangan" placeholder="Harga Ruangan" name="hargaruangan"> </div>
                  <div class="form-group">
                    <label for="exampleInputEmail1">Satuan Ruangan</label>
                    <select class="custom-control custom-select" name="satuanruangan" id="satuanruangan">
                  ...
                  <div class="form-group">
                    ...
                    <input type="number" class="form-control" placeholder="Kapasitas Ruangan" required="required" name="kapasitasruangan" id="kapasitasruangan"> </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <select class="custom-control custom-select" name="statusruangan" id="statusruangan">
                      <option selected="">Open this select menu</option>
