  ...
  <div class="py-5">
    <div class="container-fluid">
      <div class="row">
        ...
        <div class="col-md-9">
          <h1 class="text-primary text-left display-4">Perbarui Peralatan</h1>
          <div class="row">
            <div class="col-md-12">
              <div class="card-body">
                <form action="<?php echo base_url(); ?>admin/peralatan/ubah/<?php echo $data_peralatan->id_peralatan; ?>" method="post" enctype="multipart/form-data">
                  <div class="form-group">
                    <label>Nama Peralatan</label>
                    <input type="text" class="form-control" placeholder="Nama peralatan" required="required" id="namaperalatan" name="namaperalatan" value="<?php echo $data_peralatan->nama_peralatan; ?>"> </div>
                  <div class="form-group">
                    <label for="exampleInputEmail1">Deskripsi Peralatan</label>
                    <textarea class="form-control" id="deskripsiperalatan" rows="3" placeholder="Deskripsi Peralatan" name="deskripsiperalatan" ><?php echo $data_peralatan->deskripsi_peralatan; ?></textarea>
                  </div>
                  <div class="form-group">
                    <label for="exampleInputEmail1">Harga Peralatan</label>
                    <input type="text" class="form-control" id="hargaperalatan" placeholder="Harga Peralatan" name="hargaperalatan" value="<?php echo $data_peralatan->harga_peralatan; ?>"> </div>
                  <div class="form-group">
                    ...
                    <select class="custom-control custom-select" id="satuanperalatan" name="satuanperalatan">
                      ...
                      <option value="1" <?php if($data_peralatan->satuan_peralatan == '0') { echo "selected"; } ?>>Per Hari</option>
                    </select>
                  </div>
                  <div class="form-group">
                    <label>Stok Peralatan</label>
                    <input type="number" class="form-control" placeholder="Stok Peralatan" required="required" id="stokperalatan" name="stokperalatan" value="<?php echo $data_peralatan->stok_peralatan; ?>"> </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <select class="custom-control custom-select" id="statusperalatan" name="statusperalatan">
                      <option selected="" value="Open this select menu">Open this select menu</option>
                      <option value="1" <?php if($data_peralatan->satuan_peralatan == '0') { echo "selected"; } ?>>Tidak Aktif</option>
                      <option value="2" <?php if($data_peralatan->satuan_peralatan == '1') { echo "selected"; } ?>>Aktif</option>
                    </select>
                  </div>
