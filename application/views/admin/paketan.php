  ...
  <div class="py-5">
    <div class="container-fluid">
      <div class="row">
        ...
        <div class="col-md-9">
          <h1 class="text-primary text-left display-4">Paketan</h1>
          <div class="row">
            <div class="col-md-12 my-4">
              <div class="row">
                <div class="col-md-12">
                  <a href="<?php echo base_url(); ?>admin/paketan/tambah" class="btn btn-primary text-light">Tambah</a>
                </div>
              </div>
              <table class="table my-2">
                <thead>
                  <tr>
                    ...
                    <th>Status Paketan</th>
                    <th>Ruangan</th>
                    <th>Aksi</th>
                  </tr>
                </thead>
                <tbody>
                <?php $no=1; foreach($select_paketan as $data_paketan) { ?>
                  <tr>
                    <td><?php echo $no++; ?></td>
                    <td><?php echo $data_paketan->nama_paketan; ?></td>
                    <td><?php echo $data_paketan->harga_paketan; ?></td>
                    <td><?php echo $data_paketan->satuan_paketan; ?></td>
                    <td><?php echo $data_paketan->status_paketan; ?></td>
                    <td><?php echo $data_paketan->id_ruang; ?></td>
                    <td>
                      <a href="<?php echo base_url(); ?>admin/paketan/ubah/<?php echo $data_paketan->id_paketan; ?>" class="btn btn-outline-primary">Ubah</a>&nbsp; &nbsp;
                      <a class="btn btn-primary" href="#modal-hapus" data-toggle="modal" data-target="#modal-hapus<?php echo $data_paketan->id_paketan; ?>">Hapus</a>
                    </td>
                  </tr>

                  <div class="modal" id="modal-hapus<?php echo $data_paketan->id_paketan; ?>">
                    <div class="modal-dialog" role="document">
                      <div class="modal-content">
                        ...
                        <div class="modal-footer">
                          <a href="<?php echo base_url(); ?>admin/paketan/hapus/<?php echo $data_paketan->id_paketan; ?>"><button type="button" class="btn btn-primary">Ya</button></a>
